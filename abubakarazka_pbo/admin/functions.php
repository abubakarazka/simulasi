...
function tambahUser($data){
    ...
    $query = "INSERT INTO user VALUES(NULL, '$nama_user', '$username', '$password','$foto', '$roles','$created_at','$update_at')";
...
function tambahProduk($data){
    ...
    $query = "INSERT INTO barang VALUES(NULL, '$nama_barang','$jenis_barang', '$foto', '$harga_satuan', '$stok')";
